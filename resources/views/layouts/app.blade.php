...
<head>
    ...
    <style>
        /* Reset semua rounded menjadi rectangle */
        * {
        ...
        /* Sidebar Styling */
        .sidebar {
            width: 200px; /* Diperlebar sedikit agar proporsional */
            height: 100vh;
            position: fixed;
            left: 10;
            top: 0;
        ...
        /* Navbar/Header Styling - Dibuat ke kanan */
        .top-navbar {
            position: fixed;
            top: 0;
            left: 250px; /* Sama dengan lebar sidebar */
            right: 0;
            height: 80px;
            background: white; /* Menghilangkan blur agar lebih rectangle solid */
        ...
        .main-content {
            margin-left: 250px; /* Mengikuti lebar sidebar */
            padding-top: 80px;
            min-height: 100vh;
        }
        ...
        /* Menghilangkan scrollbar pada sidebar jika tidak perlu */
    ...
    <div class="flex">
        <aside class="sidebar flex flex-col py-6 no-scrollbar">
            ...
            <nav class="flex-1">
                ...
                <a href="{{ route('produk.index') }}" class="sidebar-item {{ request()->is('produk*') ? 'active' : '' }}">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <nav class="top-navbar">
                ...
                <div class="flex items-center gap-6">
                    <a href="#" class="text-gray-800 font-bold no-underline hover:text-red-600 text-xs tracking-widest">HUBUNGI KAMI</a>
                    <a href="#" class="text-gray-800 font-bold no-underline hover:text-red-600 text-xs tracking-widest">FAQ</a>
                    <div class="ms-2">
                        <img src="{{ asset('images/avatar.jpeg') }}" class="border border-gray-200" width="40" height="40" style="object-fit: cover; border-radius: 50% !important;">
                    </div>
                </div>
            </nav>
